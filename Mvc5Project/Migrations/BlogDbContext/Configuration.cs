namespace Mvc5Project.Migrations.BlogDbContext
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Models.BlogDbContext>
    {
        ...
        protected override void Seed(Models.BlogDbContext context)
        {
            ...
            context.Comments.AddOrUpdate(new Models.Comment { Id = "cmt1", PostId = "1", Body = "Vivamus hendrerit commodo pulvinar. In convallis nunc nec scelerisque sodales. Curabitur aliquam neque dolor, hendrerit cursus felis ultricies ac. Mauris ac justo vel lorem condimentum malesuada. Vivamus porttitor vestibulum lorem a luctus. Suspendisse in eleifend orci.", DateTime = DateTime.Now, UserName = "eldarion" });
            context.Comments.AddOrUpdate(new Models.Comment { Id = "cmt2", PostId = "1", Body = "Suspendisse egestas risus eget posuere egestas. Nunc facilisis ligula et vestibulum pretium. Suspendisse potenti. Nulla facilisi. Integer mi lorem, efficitur quis viverra in, sollicitudin id urna. Maecenas scelerisque, tellus eget rutrum pulvinar, velit erat pulvinar risus, vitae convallis quam mi ut leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut posuere lacus ex, eget tristique quam eleifend molestie.", DateTime = DateTime.Now, UserName = "aranwe" });
            context.Comments.AddOrUpdate(new Models.Comment { Id = "cmt3", PostId = "1", Body = "Integer lacinia ipsum magna, ac sodales libero porttitor at. Donec at enim felis. Ut bibendum lorem odio, quis ultricies elit eleifend ut. Fusce erat tellus, eleifend at gravida in, fermentum et tellus. Fusce at massa vehicula, maximus diam nec, lacinia lectus.", DateTime = DateTime.Now, UserName = "theon" });


            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep1", PostId = "1", CommentId = "cmt3", DateTime = DateTime.Now, UserName = "thelw", Body = "Cras sodales justo sit amet libero placerat consectetur. Duis hendrerit facilisis tempor. Nullam ut nisl nec neque posuere semper. Praesent vestibulum id purus quis maximus." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep9", PostId = "1", CommentId = "cmt3", DateTime = DateTime.Now, UserName = "aranwe", Body = "Cras sodales justo sit amet libero placerat consectetur. Duis hendrerit facilisis tempor. Nullam ut nisl nec neque posuere semper. Praesent vestibulum id purus quis maximus." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep2", PostId = "1", CommentId = "cmt3", ParentReplyId = "rep1", DateTime = DateTime.Now, UserName = "eldar", Body = "Mauris pulvinar tristique libero id ornare. Quisque sit amet accumsan leo. Vestibulum dapibus elit sed lorem lacinia suscipit. In hac habitasse platea dictumst. Vivamus egestas leo eu nulla faucibus cursus." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep3", PostId = "1", CommentId = "cmt3", ParentReplyId = "rep2", DateTime = DateTime.Now, UserName = "eldarion", Body = "Suspendisse consequat dolor urna, sit amet accumsan lectus luctus eget. Vestibulum maximus ante vel placerat cursus. Nulla luctus augue ac vulputate aliquet." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep4", PostId = "1", CommentId = "cmt3", ParentReplyId = "rep3", DateTime = DateTime.Now, UserName = "theon", Body = "Donec aliquam, sem a tincidunt tincidunt, orci velit mollis magna, vel auctor arcu augue nec risus. Integer luctus enim ac viverra luctus." });

            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep5", PostId = "1", CommentId = "cmt2", DateTime = DateTime.Now, UserName = "theon", Body = "Cras sodales justo sit amet libero placerat consectetur. Duis hendrerit facilisis tempor. Nullam ut nisl nec neque posuere semper. Praesent vestibulum id purus quis maximus." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep6", PostId = "1", CommentId = "cmt2", ParentReplyId = "rep5", DateTime = DateTime.Now, UserName = "eldar", Body = "Mauris pulvinar tristique libero id ornare. Quisque sit amet accumsan leo. Vestibulum dapibus elit sed lorem lacinia suscipit." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep7", PostId = "1", CommentId = "cmt2", ParentReplyId = "rep6", DateTime = DateTime.Now, UserName = "eldarion", Body = "Suspendisse consequat dolor urna, sit amet accumsan lectus luctus eget. Vestibulum maximus ante vel placerat cursus. Nulla luctus augue ac vulputate aliquet." });
            context.Replies.AddOrUpdate(new Models.Reply { Id = "rep8", PostId = "1", CommentId = "cmt2", ParentReplyId = "rep7", DateTime = DateTime.Now, UserName = "thelw", Body = "Donec aliquam, sem a tincidunt tincidunt, orci velit mollis magna, vel auctor arcu augue nec risus. Integer luctus enim ac viverra luctus." });
